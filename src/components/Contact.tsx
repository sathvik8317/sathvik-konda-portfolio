...
const Contact = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-[#fafdff] rounded-3xl shadow-md px-8 py-8 flex flex-col gap-8 border border-blue-100/60">
      <h2 className="text-2xl font-extrabold text-[#003049] mb-2">Contact</h2>
      <div className="flex flex-col md:flex-row gap-8">
        ...
        >
          <input
            ...
            placeholder="Name"
            required
            className="border border-slate-200 rounded-lg px-4 py-2 bg-blue-50 focus:outline-none focus:border-blue-400"
            value={form.name}
          ...
          <button
            type="submit"
            className="mt-2 bg-[#ffe066] text-[#003049] px-4 py-2 rounded-lg font-bold hover:bg-[#ffd43b] transition shadow border border-[#ffe066]"
          >
            Send Message
          </button>
          {submitted && (
