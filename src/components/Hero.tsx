      ...
      <div className="flex-1 flex justify-center sm:justify-end z-10">
        <div className="relative group">
          ...
          <div className="relative z-10 overflow-hidden rounded-full w-40 h-40 shadow-lg border-4 border-card bg-card flex items-center justify-center">
            {profileImage ? <img src={profileImage} alt="User-selected profile" className="w-full h-full object-cover" aria-label="Profile picture" /> : <span className="text-muted-foreground text-7xl" role="img" aria-label="Default profile avatar">🧑‍💼</span>}
            {/* Edit Icon Overlay */}
