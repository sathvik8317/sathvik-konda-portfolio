      ...
      <div className="flex-1 flex flex-col items-center sm:items-start text-center sm:text-left relative z-10">
        <div className="w-full">
          ...
          <div className="flex gap-4">
            <a href="#projects" className="bg-[#00BFFF] text-[#17191A] px-6 py-2 rounded-lg font-semibold shadow transition duration-150 hover:-translate-y-1 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00BFFF] focus-visible:ring-offset-2" tabIndex={0}>
              View Projects
            </a>
            <a href="/resume.png" download="Sathvik_Konda_Resume.png" className="border border-[#00BFFF] text-[#00BFFF] px-6 py-2 rounded-lg font-semibold transition duration-150 hover:bg-[#17191A] hover:text-[#00BFFF] hover:-translate-y-1 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00BFFF] focus-visible:ring-offset-2" tabIndex={0}>
              Download Resume
            </a>
          </div>
        </div>
      ...
      <div className="flex-1 flex justify-center sm:justify-end z-10">
        <div className="relative group">
          ...
          <div className="relative z-10 overflow-hidden rounded-full w-40 h-40 shadow-lg border-4 border-white bg-slate-200 flex items-center justify-center">
            {profileImage ? <img src={profileImage} alt="User-selected profile" className="w-full h-full object-cover" aria-label="Profile picture" /> : <span className="text-slate-400 text-7xl" role="img" aria-label="Default profile avatar">🧑‍💼</span>}
            {/* Edit Icon Overlay */}
            <button onClick={handleEditClick} className="absolute bottom-3 right-3 bg-[#17191A]/80 hover:bg-[#17191A] text-[#00BFFF] p-2 rounded-full shadow border border-[#272930] group-hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#00BFFF] focus:ring-offset-2 transition" aria-label="Edit profile picture" type="button">
