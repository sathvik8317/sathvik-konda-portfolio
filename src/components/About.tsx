  ...
  <div className="max-w-4xl mx-auto bg-[#fafdff] rounded-3xl shadow-md px-8 py-8 flex flex-col gap-6 border border-blue-100/60">
    ...
    <div className="flex flex-col sm:flex-row gap-8">
      <div className="flex-1 text-slate-700 text-base leading-relaxed">
        ...
        <div className="mt-6">
          <h3 className="font-semibold text-[#003049] mb-1">Research Work</h3>
      ...
      <div className="flex-1 bg-blue-50 rounded-2xl px-6 py-5 shadow border border-blue-100/80">
        <h3 className="font-semibold text-[#003049] mb-3">Education</h3>
